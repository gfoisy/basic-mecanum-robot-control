...
calculateStepperSpeeds(); //With the velocity vector and intensity , calculate and set the direction and speed for the stepper motors//
...
//check the battery every once and a while
}
